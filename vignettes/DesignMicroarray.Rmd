...
\begin{centerfig}
```{r expr11,eval=TRUE,echo=FALSE,fig=TRUE,include=TRUE,height=4,width=4.5}
...
\begin{centerfig}
```{r expr13,eval=TRUE,echo=FALSE,fig=TRUE,include=TRUE,height=4,width=4.5}
ranges <- range(c(x_out$x, x))
ramp <- colorRampPalette(c("white", "yellow", "orange", "red"),
	space = "rgb")
smoothScatter(x, x_out$x,
...
\begin{centerfig}
```{r expr17,eval=TRUE,echo=FALSE,fig=TRUE,include=TRUE,height=4,width=4.5}
ranges <- range(c(x_out$x, x))
ramp <- colorRampPalette(c("white", "yellow", "orange", "red"),
	space = "rgb")
smoothScatter(x[], x_out$x[],
